...
#endif`,Mu="gl_FragColor = linearToOutputTexel( gl_FragColor );",wu=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Hn,depthTest:!1,depthWrite:!1})}function Up(o,t,e){const n=new Float32Array(yi),i=new z(0,1,0);return new Rn({name:"SphericalGaussianBlur",defines:{n:yi,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${o}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Po(),fragmentShader:`
		...
		`,blending:Hn,depthTest:!1,depthWrite:!1})}function Nc(){return new Rn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Po(),fragmentShader:`
		...
		`,blending:Hn,depthTest:!1,depthWrite:!1})}function Uc(){return new Rn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Po(),fragmentShader:`
	...
	`}class Ql extends An{constructor(t=1,e={}){super(t,t,e),this.isWebGLCubeRenderTarget=!0;const n={width:t,height:t,depth:1},i=[n,n,n,n,n,n];this.texture=new ql(i),this._setTextureOptions(e),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(t,e){this.texture.type=e.type,this.texture.colorSpace=e.colorSpace,this.texture.generateMipmaps=e.generateMipmaps,this.texture.minFilter=e.minFilter,this.texture.magFilter=e.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new D(a,c),d=new Oa(-1,1,1,-1,0,1);let u=null,h=null,f=!1,m,v=null,p=[],g=!1;this.setSize=function(_,w){s.setSize(_,w),r.setSize(_,w);for(let M=0;M<p.length;M++){const A=p[M];A.setSize&&A.setSize(_,w)}},this.setEffects=function(_){p=_,g=p.length>0&&p[0].isRenderPass===!0;const w=s.width,M=s.height;for(let A=0;A<p.length;A++){const b=p[A];b.setSize&&b.setSize(w,M)}},this.begin=function(_,w){if(f||_.toneMapping===Tn&&p.length===0)return!1;if(v=w,w!==null){const M=w.width,A=w.height;(s.width!==M||s.height!==A)&&this.setSize(M,A)}return g===!1&&_.setRenderTarget(s),m=_.toneMapping,_.toneMapping=Tn,!0},this.hasRenderPass=function(){return g},this.end=function(_,w){_.toneMapping=m,f=!0;let M=s,A=r;for(let b=0;b<p.length;b++){const R=p[b];if(R.enabled!==!1&&(R.render(_,A,M,w),R.needsSwap!==!1)){const x=M;M=A,A=x}}if(u!==_.outputColorSpace||h!==_.toneMapping){u=_.outputColorSpace,h=_.toneMapping,c.defines={},ae.getTransfer(u)===ue&&(c.defines.SRGB_TRANSFER="");const b=Hp[h];b&&(c.defines[b]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=M.texture,_.setRenderTarget(v),_.render(l,d),v=null,f=!1},this.isCompositing=function(){return f},this.dispose=function(){s.dispose(),r.dispose(),a.dispose(),c.dispose()}}const th=new He,va=new Cs(1,1),eh=new Gl,nh=new ld,ih=new ql,Fc=[],Oc=[],Bc=new Float32Array(16),zc=new Float32Array(9),Gc=new Float32Array(4);function os(o,t,e){const n=o[0];if(n<=0||n>0)return o;const i=t*e;let s=Fc[i];if(s===void 0&&(s=new Float32Array(i),Fc[i]=s),t!==0){n.toArray(s,0);for(let r=1,a=0;r!==t;++r)a+=e,o[r].toArray(s,a)}return s}function Le(o,t){if(o.length!==t.length)return!1;for(let e=0,n=o.length;e<n;e++)if(o[e]!==t[e])return!1;return!0}function Ne(o,t){for(let e=0,n=t.length;e<n;e++)o[e]=t[e]}function Io(o,t){let e=Oc[t];e===void 0&&(e=new Int32Array(t),Oc[t]=e);for(let n=0;n!==t;++n)e[n]=o.allocateTextureUnit();return e}function Xp(o,t){const e=this.cache;e[0]!==t&&(o.uniform1f(this.addr,t),e[0]=t)}function Yp(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(o.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Le(e,t))return;o.uniform2fv(this.addr,t),Ne(e,t)}}function qp(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(o.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(o.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Le(e,t))return;o.uniform3fv(this.addr,t),Ne(e,t)}}function jp(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(o.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Le(e,t))return;o.uniform4fv(this.addr,t),Ne(e,t)}}function Kp(o,t){const e=this.cache,n=t.elements;if(n===void 0){if(Le(e,t))return;o.uniformMatrix2fv(this.addr,!1,t),Ne(e,t)}else{if(Le(e,n))return;Gc.set(n),o.uniformMatrix2fv(this.addr,!1,Gc),Ne(e,n)}}function $p(o,t){const e=this.cache,n=t.elements;if(n===void 0){if(Le(e,t))return;o.uniformMatrix3fv(this.addr,!1,t),Ne(e,t)}else{if(Le(e,n))return;zc.set(n),o.uniformMatrix3fv(this.addr,!1,zc),Ne(e,n)}}function Zp(o,t){const e=this.cache,n=t.elements;if(n===void 0){if(Le(e,t))return;o.uniformMatrix4fv(this.addr,!1,t),Ne(e,t)}else{if(Le(e,n))return;Bc.set(n),o.uniformMatrix4fv(this.addr,!1,Bc),Ne(e,n)}}function Jp(o,t){const e=this.cache;e[0]!==t&&(o.uniform1i(this.addr,t),e[0]=t)}function Qp(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(o.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Le(e,t))return;o.uniform2iv(this.addr,t),Ne(e,t)}}function tm(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(o.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Le(e,t))return;o.uniform3iv(this.addr,t),Ne(e,t)}}function em(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(o.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Le(e,t))return;o.uniform4iv(this.addr,t),Ne(e,t)}}function nm(o,t){const e=this.cache;e[0]!==t&&(o.uniform1ui(this.addr,t),e[0]=t)}function im(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(o.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Le(e,t))return;o.uniform2uiv(this.addr,t),Ne(e,t)}}function sm(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(o.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Le(e,t))return;o.uniform3uiv(this.addr,t),Ne(e,t)}}function om(o,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(o.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Le(e,t))return;o.uniform4uiv(this.addr,t),Ne(e,t)}}function rm(o,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i);let s;this.type===o.SAMPLER_2D_SHADOW?(va.compareFunction=e.isReversedDepthBuffer()?Ra:Ca,s=va):s=th,e.setTexture2D(t||s,i)}function am(o,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||nh,i)}function cm(o,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||ih,i)}function lm(o,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(o.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||eh,i)}function hm(o){switch(o){case 5126:return Xp;case 35664:return Yp;case 35665:return qp;case 35666:return jp;case 35674:return Kp;case 35675:return $p;case 35676:return Zp;case 5124:case 35670:return Jp;case 35667:case 35671:return Qp;case 35668:case 35672:return tm;case 35669:case 35673:return em;case 5125:return nm;case 36294:return im;case 36295:return sm;case 36296:return om;case 35678:case 36198:case 36298:case 36306:case 35682:return rm;case 35679:case 36299:case 36307:return am;case 35680:case 36300:case 36308:case 36293:return cm;case 36289:case 36303:case 36311:case 36292:return lm}}function dm(o,t){o.uniform1fv(this.addr,t)}function um(o,t){const e=os(t,this.size,2);o.uniform2fv(this.addr,e)}function fm(o,t){const e=os(t,this.size,3);o.uniform3fv(this.addr,e)}function pm(o,t){const e=os(t,this.size,4);o.uniform4fv(this.addr,e)}function mm(o,t){const e=os(t,this.size,4);o.uniformMatrix2fv(this.addr,!1,e)}function gm(o,t){const e=os(t,this.size,9);o.uniformMatrix3fv(this.addr,!1,e)}function vm(o,t){const e=os(t,this.size,16);o.uniformMatrix4fv(this.addr,!1,e)}function _m(o,t){o.uniform1iv(this.addr,t)}function xm(o,t){o.uniform2iv(this.addr,t)}function ym(o,t){o.uniform3iv(this.addr,t)}function Mm(o,t){o.uniform4iv(this.addr,t)}function wm(o,t){o.uniform1uiv(this.addr,t)}function Sm(o,t){o.uniform2uiv(this.addr,t)}function bm(o,t){o.uniform3uiv(this.addr,t)}function Em(o,t){o.uniform4uiv(this.addr,t)}function Tm(o,t,e){const n=this.cache,i=t.length,s=Io(e,i);Le(n,s)||(o.uniform1iv(this.addr,s),Ne(n,s));let r;this.type===o.SAMPLER_2D_SHADOW?r=va:r=th;for(let a=0;a!==i;++a)e.setTexture2D(t[a]||r,s[a])}function Am(o,t,e){const n=this.cache,i=t.length,s=Io(e,i);Le(n,s)||(o.uniform1iv(this.addr,s),Ne(n,s));for(let r=0;r!==i;++r)e.setTexture3D(t[r]||nh,s[r])}function Cm(o,t,e){const n=this.cache,i=t.length,s=Io(e,i);Le(n,s)||(o.uniform1iv(this.addr,s),Ne(n,s));for(let r=0;r!==i;++r)e.setTextureCube(t[r]||ih,s[r])}function Rm(o,t,e){const n=this.cache,i=t.length,s=Io(e,i);Le(n,s)||(o.uniform1iv(this.addr,s),Ne(n,s));for(let r=0;r!==i;++r)e.setTexture2DArray(t[r]||eh,s[r])}function Pm(o){switch(o){case 5126:return dm;case 35664:return um;case 35665:return fm;case 35666:return pm;case 35674:return mm;case 35675:return gm;case 35676:return vm;case 5124:case 35670:return _m;case 35667:case 35671:return xm;case 35668:case 35672:return ym;case 35669:case 35673:return Mm;case 5125:return wm;case 36294:return Sm;case 36295:return bm;case 36296:return Em;case 35678:case 36198:case 36298:case 36306:case 35682:return Tm;case 35679:case 36299:case 36307:return Am;case 35680:case 36300:case 36308:case 36293:return Cm;case 36289:case 36303:case 36311:case 36292:return Rm}}class Im{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=hm(e.type)}}class Dm{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Pm(e.type)}}class Lm{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let s=0,r=i.length;s!==r;++s){const a=i[s];a.setValue(t,e[a.id],n)}}}const gr=/(\w+)(\])?(\[|\.)?/g;function kc(o,t){o.seq.push(t),o.map[t.id]=t}function Nm(o,t,e){const n=o.name,i=n.length;for(gr.lastIndex=0;;){const s=gr.exec(n),r=gr.lastIndex;let a=s[1];const c=s[2]==="]",l=s[3];if(c&&(a=a|0),l===void 0||l==="["&&r+2===i){kc(e,l===void 0?new Im(a,o,t):new Dm(a,o,t));break}else{let u=e.map[a];u===void 0&&(u=new Lm(a),kc(e,u)),e=u}}}class xo{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){const a=t.getActiveUniform(e,r),c=t.getUniformLocation(e,a.name);Nm(a,c,this)}const i=[],s=[];for(const r of this.seq)r.type===t.SAMPLER_2D_SHADOW||r.type===t.SAMPLER_CUBE_SHADOW||r.type===t.SAMPLER_2D_ARRAY_SHADOW?i.push(r):s.push(r);i.length>0&&(this.seq=i.concat(s))}setValue(t,e,n,i){const s=this.map[e];s!==void 0&&s.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let s=0,r=e.length;s!==r;++s){const a=e[s],c=n[a.id];c.needsUpdate!==!1&&a.setValue(t,c.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,s=t.length;i!==s;++i){const r=t[i];r.id in e&&n.push(r)}return n}}function Vc(o,t,e){const n=o.createShader(t);return o.shaderSource(n,e),o.compileShader(n),n}const Um=37297;let Fm=0;function Om(o,t){const e=o.split(`
`),n=[],i=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let r=i;r<s;r++){const a=r+1;n.push(`${a===t?">":" "} ${a}: ${e[r]}`)}return n.join(`
`)}const Hc=new Jt;function Bm(o){ae._getMatrix(Hc,ae.workingColorSpace,o);const t=`mat3( ${Hc.elements.map(e=>e.toFixed(4))} )`;switch(ae.getTransfer(o)){case yo:return[t,"LinearTransferOETF"];case ue:return[t,"sRGBTransferOETF"];default:return Xt("WebGLProgram: Unsupported color space: ",o),[t,"LinearTransferOETF"]}}function Wc(o,t,e){const n=o.getShaderParameter(t,o.COMPILE_STATUS),s=(o.getShaderInfoLog(t)||"").trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const a=parseInt(r[1]);return e.toUpperCase()+`

`+s+`

`+Om(o.getShaderSource(t),a)}else return s}function zm(o,t){const e=Bm(t);return[`vec4 ${o}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}const Gm={[bl]:"Linear",[El]:"Reinhard",[Tl]:"Cineon",[Al]:"ACESFilmic",[Rl]:"AgX",[Pl]:"Neutral",[Cl]:"Custom"};function km(o,t){const e=Gm[t];return e===void 0?(Xt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+o+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+o+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const co=new z;function Vm(){ae.getLuminanceCoefficients(co);const o=co.x.toFixed(4),t=co.y.toFixed(4),e=co.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${o}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function Hm(o){return[o.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",o.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ms).join(`
`)}function Wm(o){const t=[];for(const e in o){const n=o[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function Xm(o,t){const e={},n=o.getProgramParameter(t,o.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=o.getActiveAttrib(t,i),r=s.name;let a=1;s.type===o.FLOAT_MAT2&&(a=2),s.type===o.FLOAT_MAT3&&(a=3),s.type===o.FLOAT_MAT4&&(a=4),e[r]={type:s.type,location:o.getAttribLocation(t,r),locationSize:a}}return e}function Ms(o){return o!==""}function Xc(o,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return o.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Yc(o,t){return o.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Ym=/^[ \t]*#include +<([\w\d./]+)>/gm;function _a(o){return o.replace(Ym,jm)}const qm=new Map;function jm(o,t){let e=ee[t];if(e===void 0){const n=qm.get(t);if(n!==void 0)e=ee[n],Xt('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return _a(e)}const Km=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function qc(o){return o.replace(Km,$m)}function $m(o,t,e,n){let i="";for(let s=parseInt(t);s<parseInt(e);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function jc(o){let t=`precision ${o.precision} float;
...
#define LOW_PRECISION`),t}const Zm={[ws]:"SHADOWMAP_TYPE_PCF",[ys]:"SHADOWMAP_TYPE_VSM"};function Jm(o){return Zm[o.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Qm={[bi]:"ENVMAP_TYPE_CUBE",[Zi]:"ENVMAP_TYPE_CUBE",[Co]:"ENVMAP_TYPE_CUBE_UV"};function t0(o){return o.envMap===!1?"ENVMAP_TYPE_CUBE":Qm[o.envMapMode]||"ENVMAP_TYPE_CUBE"}const e0={[Zi]:"ENVMAP_MODE_REFRACTION"};function n0(o){return o.envMap===!1?"ENVMAP_MODE_REFLECTION":e0[o.envMapMode]||"ENVMAP_MODE_REFLECTION"}const i0={[ya]:"ENVMAP_BLENDING_MULTIPLY",[Vh]:"ENVMAP_BLENDING_MIX",[Hh]:"ENVMAP_BLENDING_ADD"};function s0(o){return o.envMap===!1?"ENVMAP_BLENDING_NONE":i0[o.combine]||"ENVMAP_BLENDING_NONE"}function o0(o){const t=o.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function r0(o,t,e,n){const i=o.getContext(),s=e.defines;let r=e.vertexShader,a=e.fragmentShader;const c=Jm(e),l=t0(e),d=n0(e),u=s0(e),h=o0(e),f=Hm(e),m=Wm(s),v=i.createProgram();let p,g,_=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+g);const w=_+p+r,M=_+g+a,A=Vc(i,i.VERTEX_SHADER,w),b=Vc(i,i.FRAGMENT_SHADER,M);i.attachShader(v,A),i.attachShader(v,b),e.index0AttributeName!==void 0?i.bindAttribLocation(v,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(v,0,"position"),i.linkProgram(v);function R(I){if(o.debug.checkShaderErrors){const B=i.getProgramInfoLog(v)||"",L=i.getShaderInfoLog(A)||"",F=i.getShaderInfoLog(b)||"",U=B.trim(),N=L.trim(),G=F.trim();let K=!0,q=!0;if(i.getProgramParameter(v,i.LINK_STATUS)===!1)if(K=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(i,v,A,b);else{const st=Wc(i,A,"vertex"),ot=Wc(i,b,"fragment");re("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(v,i.VALIDATE_STATUS)+`
