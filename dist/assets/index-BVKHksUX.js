...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function Cp(r,t,e){const n=new Float32Array(_i),i=new B(0,1,0);return new An({name:"SphericalGaussianBlur",defines:{n:_i,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Er(),fragmentShader:`
...
`)}const Lm={[gl]:"Linear",[_l]:"Reinhard",[vl]:"Cineon",[xl]:"ACESFilmic",[Ml]:"AgX",[Sl]:"Neutral",[yl]:"Custom"};function Nm(r,t){const e=Lm[t];return e===void 0?(kt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const ir=new B;function Um(){ne.getLuminanceCoefficients(ir);const r=ir.x.toFixed(4),t=ir.y.toFixed(4),e=ir.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+g);const S=v+p+o,M=v+g+a,T=Fc(i,i.VERTEX_SHADER,S),A=Fc(i,i.FRAGMENT_SHADER,M);i.attachShader(_,T),i.attachShader(_,A),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function C(P){if(r.debug.checkShaderErrors){const F=i.getProgramInfoLog(_)||"",I=i.getShaderInfoLog(T)||"",N=i.getShaderInfoLog(A)||"",L=F.trim(),D=I.trim(),z=N.trim();let K=!0,q=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(K=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,T,A);else{const st=Bc(i,T,"vertex"),rt=Bc(i,A,"fragment");ee("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`,m0=[new B(1,0,0),new B(-1,0,0),new B(0,1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1)],g0=[new B(0,-1,0),new B(0,-1,0),new B(0,0,1),new B(0,0,-1),new B(0,-1,0),new B(0,-1,0)],Yc=new _e,hs=new B,fo=new B;function _0(r,t,e){let n=new Ta;const i=new jt,s=new jt,o=new Se,a=new Cu,c=new Ru,l={},u=e.maxTextureSize,d={[si]:qe,[qe]:si,[zn]:zn},h=new An({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new jt},radius:{value:4}},vertexShader:f0,fragmentShader:p0}),f=h.clone();f.defines.HORIZONTAL_PASS=1;const m=new Ee;m.setAttribute("position",new je(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new W(m,h),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=_s;let g=this.type;this.render=function(A,C,x){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||A.length===0)return;this.type===gh&&(kt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=_s);const b=r.getRenderTarget(),k=r.getActiveCubeFace(),P=r.getActiveMipmapLevel(),F=r.state;F.setBlending(kn),F.buffers.depth.getReversed()===!0?F.buffers.color.setClear(0,0,0,0):F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const I=g!==this.type;I&&C.traverse(function(N){N.material&&(Array.isArray(N.material)?N.material.forEach(L=>L.needsUpdate=!0):N.material.needsUpdate=!0)});for(let N=0,L=A.length;N<L;N++){const D=A[N],z=D.shadow;if(z===void 0){kt("WebGLShadowMap:",D,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;i.copy(z.mapSize);const K=z.getFrameExtents();i.multiply(K),s.copy(z.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(s.x=Math.floor(u/K.x),i.x=s.x*K.x,z.mapSize.x=s.x),i.y>u&&(s.y=Math.floor(u/K.y),i.y=s.y*K.y,z.mapSize.y=s.y));const q=r.state.buffers.depth.getReversed();if(z.camera._reversedDepth=q,z.map===null||I===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===ms){if(D.isPointLight){kt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new wn(i.x,i.y,{format:Ki,type:Wn,minFilter:ke,magFilter:ke,generateMipmaps:!1}),z.map.texture.name=D.name+".shadowMap",z.map.depthTexture=new ws(i.x,i.y,yn),z.map.depthTexture.name=D.name+".shadowMapDepth",z.map.depthTexture.format=Xn,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Oe,z.map.depthTexture.magFilter=Oe}else D.isPointLight?(z.map=new Yl(i.x),z.map.depthTexture=new Su(i.x,En)):(z.map=new wn(i.x,i.y),z.map.depthTexture=new ws(i.x,i.y,En)),z.map.depthTexture.name=D.name+".shadowMap",z.map.depthTexture.format=Xn,this.type===_s?(z.map.depthTexture.compareFunction=q?Ea:wa,z.map.depthTexture.minFilter=ke,z.map.depthTexture.magFilter=ke):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Oe,z.map.depthTexture.magFilter=Oe);z.camera.updateProjectionMatrix()}const st=z.map.isWebGLCubeRenderTarget?6:1;for(let rt=0;rt<st;rt++){if(z.map.isWebGLCubeRenderTarget)r.setRenderTarget(z.map,rt),r.clear();else{rt===0&&(r.setRenderTarget(z.map),r.clear());const Z=z.getViewport(rt);o.set(s.x*Z.x,s.y*Z.y,s.x*Z.z,s.y*Z.w),F.viewport(o)}if(D.isPointLight){const Z=z.camera,yt=z.matrix,Kt=D.distance||Z.far;Kt!==Z.far&&(Z.far=Kt,Z.updateProjectionMatrix()),hs.setFromMatrixPosition(D.matrixWorld),Z.position.copy(hs),fo.copy(Z.position),fo.add(m0[rt]),Z.up.copy(g0[rt]),Z.lookAt(fo),Z.updateMatrixWorld(),yt.makeTranslation(-hs.x,-hs.y,-hs.z),Yc.multiplyMatrices(Z.projectionMatrix,Z.matrixWorldInverse),z._frustum.setFromProjectionMatrix(Yc,Z.coordinateSystem,Z.reversedDepth)}else z.updateMatrices(D);n=z.getFrustum(),M(C,x,z.camera,D,this.type)}z.isPointLightShadow!==!0&&this.type===ms&&v(z,x),z.needsUpdate=!1}g=this.type,p.needsUpdate=!1,r.setRenderTarget(b,k,P)};function v(A,C){const x=t.update(_);h.defines.VSM_SAMPLES!==A.blurSamples&&(h.defines.VSM_SAMPLES=A.blurSamples,f.defines.VSM_SAMPLES=A.blurSamples,h.needsUpdate=!0,f.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new wn(i.x,i.y,{format:Ki,type:Wn})),h.uniforms.shadow_pass.value=A.map.depthTexture,h.uniforms.resolution.value=A.mapSize,h.uniforms.radius.value=A.radius,r.setRenderTarget(A.mapPass),r.clear(),r.renderBufferDirect(C,null,x,h,_,null),f.uniforms.shadow_pass.value=A.mapPass.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,r.setRenderTarget(A.map),r.clear(),r.renderBufferDirect(C,null,x,f,_,null)}function S(A,C,x,b){let k=null;const P=x.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(P!==void 0)k=P;else if(k=x.isPointLight===!0?c:a,r.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const F=k.uuid,I=C.uuid;let N=l[F];N===void 0&&(N={},l[F]=N);let L=N[I];L===void 0&&(L=k.clone(),N[I]=L,C.addEventListener("dispose",T)),k=L}if(k.visible=C.visible,k.wireframe=C.wireframe,b===ms?k.side=C.shadowSide!==null?C.shadowSide:C.side:k.side=C.shadowSide!==null?C.shadowSide:d[C.side],k.alphaMap=C.alphaMap,k.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,k.map=C.map,k.clipShadows=C.clipShadows,k.clippingPlanes=C.clippingPlanes,k.clipIntersection=C.clipIntersection,k.displacementMap=C.displacementMap,k.displacementScale=C.displacementScale,k.displacementBias=C.displacementBias,k.wireframeLinewidth=C.wireframeLinewidth,k.linewidth=C.linewidth,x.isPointLight===!0&&k.isMeshDistanceMaterial===!0){const F=r.properties.get(k);F.light=x}return k}function M(A,C,x,b,k){if(A.visible===!1)return;if(A.layers.test(C.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&k===ms)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,A.matrixWorld);const I=t.update(A),N=A.material;if(Array.isArray(N)){const L=I.groups;for(let D=0,z=L.length;D<z;D++){const K=L[D],q=N[K.materialIndex];if(q&&q.visible){const st=S(A,q,b,k);A.onBeforeShadow(r,A,C,x,I,st,K),r.renderBufferDirect(x,null,I,st,A,K),A.onAfterShadow(r,A,C,x,I,st,K)}}}else if(N.visible){const L=S(A,N,b,k);A.onBeforeShadow(r,A,C,x,I,L,null),r.renderBufferDirect(x,null,I,L,A,null),A.onAfterShadow(r,A,C,x,I,L,null)}}const F=A.children;for(let I=0,N=F.length;I<N;I++)M(F[I],C,x,b,k)}function T(A){A.target.removeEventListener("dispose",T);for(const x in l){const b=l[x],k=A.target.uuid;k in b&&(b[k].dispose(),delete b[k])}}}function v0(r,t){function e(){let G=!1;const ut=new Se;let lt=null;const _t=new Se(0,0,0,0);return{setMask:function(at){lt!==at&&!G&&(r.colorMask(at,at,at,at),lt=at)},setLocked:function(at){G=at},setClear:function(at,J,wt,Vt,me){me===!0&&(at*=Vt,J*=Vt,wt*=Vt),ut.set(at,J,wt,Vt),_t.equals(ut)===!1&&(r.clearColor(at,J,wt,Vt),_t.copy(ut))},reset:function(){G=!1,lt=null,_t.set(-1,0,0,0)}}}function n(){let G=!1,ut=!1,lt=null,_t=null,at=null;return{setReversed:function(J){if(ut!==J){const wt=t.get("EXT_clip_control");J?wt.clipControlEXT(wt.LOWER_LEFT_EXT,wt.ZERO_TO_ONE_EXT):wt.clipControlEXT(wt.LOWER_LEFT_EXT,wt.NEGATIVE_ONE_TO_ONE_EXT),ut=J;const Vt=at;at=null,this.setClear(Vt)}},getReversed:function(){return ut},setTest:function(J){J?nt(r.DEPTH_TEST):it(r.DEPTH_TEST)},setMask:function(J){lt!==J&&!G&&(r.depthMask(J),lt=J)},setFunc:function(J){if(ut&&(J=Kh[J]),_t!==J){switch(J){case So:r.depthFunc(r.NEVER);break;case wo:r.depthFunc(r.ALWAYS);break;case Eo:r.depthFunc(r.LESS);break;case qi:r.depthFunc(r.LEQUAL);break;case bo:r.depthFunc(r.EQUAL);break;case Ao:r.depthFunc(r.GEQUAL);break;case To:r.depthFunc(r.GREATER);break;case Co:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}_t=J}},setLocked:function(J){G=J},setClear:function(J){at!==J&&(at=J,ut&&(J=1-J),r.clearDepth(J))},reset:function(){G=!1,lt=null,_t=null,at=null,ut=!1}}}function i(){let G=!1,ut=null,lt=null,_t=null,at=null,J=null,wt=null,Vt=null,me=null;return{setTest:function(oe){G||(oe?nt(r.STENCIL_TEST):it(r.STENCIL_TEST))},setMask:function(oe){ut!==oe&&!G&&(r.stencilMask(oe),ut=oe)},setFunc:function(oe,Tn,Cn){(lt!==oe||_t!==Tn||at!==Cn)&&(r.stencilFunc(oe,Tn,Cn),lt=oe,_t=Tn,at=Cn)},setOp:function(oe,Tn,Cn){(J!==oe||wt!==Tn||Vt!==Cn)&&(r.stencilOp(oe,Tn,Cn),J=oe,wt=Tn,Vt=Cn)},setLocked:function(oe){G=oe},setClear:function(oe){me!==oe&&(r.clearStencil(oe),me=oe)},reset:function(){G=!1,ut=null,lt=null,_t=null,at=null,J=null,wt=null,Vt=null,me=null}}}const s=new e,o=new n,a=new i,c=new WeakMap,l=new WeakMap;let u={},d={},h=new WeakMap,f=[],m=null,_=!1,p=null,g=null,v=null,S=null,M=null,T=null,A=null,C=new Yt(0,0,0),x=0,b=!1,k=null,P=null,F=null,I=null,N=null;const L=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let D=!1,z=0;const K=r.getParameter(r.VERSION);K.indexOf("WebGL")!==-1?(z=parseFloat(/^WebGL (\d)/.exec(K)[1]),D=z>=1):K.indexOf("OpenGL ES")!==-1&&(z=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),D=z>=2);let q=null,st={};const rt=r.getParameter(r.SCISSOR_BOX),Z=r.getParameter(r.VIEWPORT),yt=new Se().fromArray(rt),Kt=new Se().fromArray(Z);function Ht(G,ut,lt,_t){const at=new Uint8Array(4),J=r.createTexture();r.bindTexture(G,J),r.texParameteri(G,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(G,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let wt=0;wt<lt;wt++)G===r.TEXTURE_3D||G===r.TEXTURE_2D_ARRAY?r.texImage3D(ut,0,r.RGBA,1,1,_t,0,r.RGBA,r.UNSIGNED_BYTE,at):r.texImage2D(ut+wt,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,at);return J}const $={};$[r.TEXTURE_2D]=Ht(r.TEXTURE_2D,r.TEXTURE_2D,1),$[r.TEXTURE_CUBE_MAP]=Ht(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),$[r.TEXTURE_2D_ARRAY]=Ht(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),$[r.TEXTURE_3D]=Ht(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),nt(r.DEPTH_TEST),o.setFunc(qi),Ot(!1),$t(Xa),nt(r.CULL_FACE),Dt(kn);function nt(G){u[G]!==!0&&(r.enable(G),u[G]=!0)}function it(G){u[G]!==!1&&(r.disable(G),u[G]=!1)}function Lt(G,ut){return d[G]!==ut?(r.bindFramebuffer(G,ut),d[G]=ut,G===r.DRAW_FRAMEBUFFER&&(d[r.FRAMEBUFFER]=ut),G===r.FRAMEBUFFER&&(d[r.DRAW_FRAMEBUFFER]=ut),!0):!1}function Ct(G,ut){let lt=f,_t=!1;if(G){lt=h.get(ut),lt===void 0&&(lt=[],h.set(ut,lt));const at=G.textures;if(lt.length!==at.length||lt[0]!==r.COLOR_ATTACHMENT0){for(let J=0,wt=at.length;J<wt;J++)lt[J]=r.COLOR_ATTACHMENT0+J;lt.length=at.length,_t=!0}}else lt[0]!==r.BACK&&(lt[0]=r.BACK,_t=!0);_t&&r.drawBuffers(lt)}function Nt(G){return m!==G?(r.useProgram(G),m=G,!0):!1}const fe={[gi]:r.FUNC_ADD,[vh]:r.FUNC_SUBTRACT,[xh]:r.FUNC_REVERSE_SUBTRACT};fe[yh]=r.MIN,fe[Mh]=r.MAX;const Qt={[Sh]:r.ZERO,[wh]:r.ONE,[Eh]:r.SRC_COLOR,[yo]:r.SRC_ALPHA,[Ph]:r.SRC_ALPHA_SATURATE,[Ch]:r.DST_COLOR,[Ah]:r.DST_ALPHA,[bh]:r.ONE_MINUS_SRC_COLOR,[Mo]:r.ONE_MINUS_SRC_ALPHA,[Rh]:r.ONE_MINUS_DST_COLOR,[Th]:r.ONE_MINUS_DST_ALPHA,[Ih]:r.CONSTANT_COLOR,[Dh]:r.ONE_MINUS_CONSTANT_COLOR,[Lh]:r.CONSTANT_ALPHA,[Nh]:r.ONE_MINUS_CONSTANT_ALPHA};function Dt(G,ut,lt,_t,at,J,wt,Vt,me,oe){if(G===kn){_===!0&&(it(r.BLEND),_=!1);return}if(_===!1&&(nt(r.BLEND),_=!0),G!==_h){if(G!==p||oe!==b){if((g!==gi||M!==gi)&&(r.blendEquation(r.FUNC_ADD),g=gi,M=gi),oe)switch(G){case Xi:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Ya:r.blendFunc(r.ONE,r.ONE);break;case qa:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case ja:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:ee("WebGLState: Invalid blending: ",G);break}else switch(G){case Xi:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Ya:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case qa:ee("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case ja:ee("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:ee("WebGLState: Invalid blending: ",G);break}v=null,S=null,T=null,A=null,C.set(0,0,0),x=0,p=G,b=oe}return}at=at||ut,J=J||lt,wt=wt||_t,(ut!==g||at!==M)&&(r.blendEquationSeparate(fe[ut],fe[at]),g=ut,M=at),(lt!==v||_t!==S||J!==T||wt!==A)&&(r.blendFuncSeparate(Qt[lt],Qt[_t],Qt[J],Qt[wt]),v=lt,S=_t,T=J,A=wt),(Vt.equals(C)===!1||me!==x)&&(r.blendColor(Vt.r,Vt.g,Vt.b,me),C.copy(Vt),x=me),p=G,b=!1}function Ut(G,ut){G.side===zn?it(r.CULL_FACE):nt(r.CULL_FACE);let lt=G.side===qe;ut&&(lt=!lt),Ot(lt),G.blending===Xi&&G.transparent===!1?Dt(kn):Dt(G.blending,G.blendEquation,G.blendSrc,G.blendDst,G.blendEquationAlpha,G.blendSrcAlpha,G.blendDstAlpha,G.blendColor,G.blendAlpha,G.premultipliedAlpha),o.setFunc(G.depthFunc),o.setTest(G.depthTest),o.setMask(G.depthWrite),s.setMask(G.colorWrite);const _t=G.stencilWrite;a.setTest(_t),_t&&(a.setMask(G.stencilWriteMask),a.setFunc(G.stencilFunc,G.stencilRef,G.stencilFuncMask),a.setOp(G.stencilFail,G.stencilZFail,G.stencilZPass)),ve(G.polygonOffset,G.polygonOffsetFactor,G.polygonOffsetUnits),G.alphaToCoverage===!0?nt(r.SAMPLE_ALPHA_TO_COVERAGE):it(r.SAMPLE_ALPHA_TO_COVERAGE)}function Ot(G){k!==G&&(G?r.frontFace(r.CW):r.frontFace(r.CCW),k=G)}function $t(G){G!==ph?(nt(r.CULL_FACE),G!==P&&(G===Xa?r.cullFace(r.BACK):G===mh?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):it(r.CULL_FACE),P=G}function U(G){G!==F&&(D&&r.lineWidth(G),F=G)}function ve(G,ut,lt){G?(nt(r.POLYGON_OFFSET_FILL),(I!==ut||N!==lt)&&(I=ut,N=lt,o.getReversed()&&(ut=-ut),r.polygonOffset(ut,lt))):it(r.POLYGON_OFFSET_FILL)}function re(G){G?nt(r.SCISSOR_TEST):it(r.SCISSOR_TEST)}function pe(G){G===void 0&&(G=r.TEXTURE0+L-1),q!==G&&(r.activeTexture(G),q=G)}function At(G,ut,lt){lt===void 0&&(q===null?lt=r.TEXTURE0+L-1:lt=q);let _t=st[lt];_t===void 0&&(_t={type:void 0,texture:void 0},st[lt]=_t),(_t.type!==G||_t.texture!==ut)&&(q!==lt&&(r.activeTexture(lt),q=lt),r.bindTexture(G,ut||$[G]),_t.type=G,_t.texture=ut)}function R(){const G=st[q];G!==void 0&&G.type!==void 0&&(r.bindTexture(G.type,null),G.type=void 0,G.texture=void 0)}function y(){try{r.compressedTexImage2D(...arguments)}catch(G){ee("WebGLState:",G)}}function V(){try{r.compressedTexImage3D(...arguments)}catch(G){ee("WebGLState:",G)}}function tt(){try{r.texSubImage2D(...arguments)}catch(G){ee("WebGLState:",G)}}function et(){try{r.texSubImage3D(...arguments)}catch(G){ee("WebGLState:",G)}}function Q(){try{r.compressedTexSubImage2D(...arguments)}catch(G){ee("WebGLState:",G)}}function Mt(){try{r.compressedTexSubImage3D(...arguments)}catch(G){ee("WebGLState:",G)}}function ht(){try{r.texStorage2D(...arguments)}catch(G){ee("WebGLState:",G)}}function It(){try{r.texStorage3D(...arguments)}catch(G){ee("WebGLState:",G)}}function Bt(){try{r.texImage2D(...arguments)}catch(G){ee("WebGLState:",G)}}function ot(){try{r.texImage3D(...arguments)}catch(G){ee("WebGLState:",G)}}function ct(G){yt.equals(G)===!1&&(r.scissor(G.x,G.y,G.z,G.w),yt.copy(G))}function St(G){Kt.equals(G)===!1&&(r.viewport(G.x,G.y,G.z,G.w),Kt.copy(G))}function Et(G,ut){let lt=l.get(ut);lt===void 0&&(lt=new WeakMap,l.set(ut,lt));let _t=lt.get(G);_t===void 0&&(_t=r.getUniformBlockIndex(ut,G.name),lt.set(G,_t))}function mt(G,ut){const _t=l.get(ut).get(G);c.get(ut)!==_t&&(r.uniformBlockBinding(ut,_t,G.__bindingPointIndex),c.set(ut,_t))}function Zt(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),o.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),u={},q=null,st={},d={},h=new WeakMap,f=[],m=null,_=!1,p=null,g=null,v=null,S=null,M=null,T=null,A=null,C=new Yt(0,0,0),x=0,b=!1,k=null,P=null,F=null,I=null,N=null,yt.set(0,0,r.canvas.width,r.canvas.height),Kt.set(0,0,r.canvas.width,r.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:nt,disable:it,bindFramebuffer:Lt,drawBuffers:Ct,useProgram:Nt,setBlending:Dt,setMaterial:Ut,setFlipSided:Ot,setCullFace:$t,setLineWidth:U,setPolygonOffset:ve,setScissorTest:re,activeTexture:pe,bindTexture:At,unbindTexture:R,compressedTexImage2D:y,compressedTexImage3D:V,texImage2D:Bt,texImage3D:ot,updateUBOMapping:Et,uniformBlockBinding:mt,texStorage2D:ht,texStorage3D:It,texSubImage2D:tt,texSubImage3D:et,compressedTexSubImage2D:Q,compressedTexSubImage3D:Mt,scissor:ct,viewport:St,reset:Zt}}function x0(r,t,e,n,i,s,o){const a=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new jt,u=new WeakMap;let d;const h=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function m(R,y){return f?new OffscreenCanvas(R,y):mr("canvas")}function _(R,y,V){let tt=1;const et=At(R);if((et.width>V||et.height>V)&&(tt=V/Math.max(et.width,et.height)),tt<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){const Q=Math.floor(tt*et.width),Mt=Math.floor(tt*et.height);d===void 0&&(d=m(Q,Mt));const ht=y?m(Q,Mt):d;return ht.width=Q,ht.height=Mt,ht.getContext("2d").drawImage(R,0,0,Q,Mt),kt("WebGLRenderer: Texture has been resized from ("+et.width+"x"+et.height+") to ("+Q+"x"+Mt+")."),ht}else return"data"in R&&kt("WebGLRenderer: Image in DataTexture is too big ("+et.width+"x"+et.height+")."),R;return R}function p(R){return R.generateMipmaps}function g(R){r.generateMipmap(R)}function v(R){return R.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?r.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function S(R,y,V,tt,et=!1){if(R!==null){if(r[R]!==void 0)return r[R];kt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let Q=y;if(y===r.RED&&(V===r.FLOAT&&(Q=r.R32F),V===r.HALF_FLOAT&&(Q=r.R16F),V===r.UNSIGNED_BYTE&&(Q=r.R8)),y===r.RED_INTEGER&&(V===r.UNSIGNED_BYTE&&(Q=r.R8UI),V===r.UNSIGNED_SHORT&&(Q=r.R16UI),V===r.UNSIGNED_INT&&(Q=r.R32UI),V===r.BYTE&&(Q=r.R8I),V===r.SHORT&&(Q=r.R16I),V===r.INT&&(Q=r.R32I)),y===r.RG&&(V===r.FLOAT&&(Q=r.RG32F),V===r.HALF_FLOAT&&(Q=r.RG16F),V===r.UNSIGNED_BYTE&&(Q=r.RG8)),y===r.RG_INTEGER&&(V===r.UNSIGNED_BYTE&&(Q=r.RG8UI),V===r.UNSIGNED_SHORT&&(Q=r.RG16UI),V===r.UNSIGNED_INT&&(Q=r.RG32UI),V===r.BYTE&&(Q=r.RG8I),V===r.SHORT&&(Q=r.RG16I),V===r.INT&&(Q=r.RG32I)),y===r.RGB_INTEGER&&(V===r.UNSIGNED_BYTE&&(Q=r.RGB8UI),V===r.UNSIGNED_SHORT&&(Q=r.RGB16UI),V===r.UNSIGNED_INT&&(Q=r.RGB32UI),V===r.BYTE&&(Q=r.RGB8I),V===r.SHORT&&(Q=r.RGB16I),V===r.INT&&(Q=r.RGB32I)),y===r.RGBA_INTEGER&&(V===r.UNSIGNED_BYTE&&(Q=r.RGBA8UI),V===r.UNSIGNED_SHORT&&(Q=r.RGBA16UI),V===r.UNSIGNED_INT&&(Q=r.RGBA32UI),V===r.BYTE&&(Q=r.RGBA8I),V===r.SHORT&&(Q=r.RGBA16I),V===r.INT&&(Q=r.RGBA32I)),y===r.RGB&&(V===r.UNSIGNED_INT_5_9_9_9_REV&&(Q=r.RGB9_E5),V===r.UNSIGNED_INT_10F_11F_11F_REV&&(Q=r.R11F_G11F_B10F)),y===r.RGBA){const Mt=et?pr:ne.getTransfer(tt);V===r.FLOAT&&(Q=r.RGBA32F),V===r.HALF_FLOAT&&(Q=r.RGBA16F),V===r.UNSIGNED_BYTE&&(Q=Mt===ae?r.SRGB8_ALPHA8:r.RGBA8),V===r.UNSIGNED_SHORT_4_4_4_4&&(Q=r.RGBA4),V===r.UNSIGNED_SHORT_5_5_5_1&&(Q=r.RGB5_A1)}return(Q===r.R16F||Q===r.R32F||Q===r.RG16F||Q===r.RG32F||Q===r.RGBA16F||Q===r.RGBA32F)&&t.get("EXT_color_buffer_float"),Q}function M(R,y){let V;return R?y===null||y===En||y===ys?V=r.DEPTH24_STENCIL8:y===yn?V=r.DEPTH32F_STENCIL8:y===xs&&(V=r.DEPTH24_STENCIL8,kt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):y===null||y===En||y===ys?V=r.DEPTH_COMPONENT24:y===yn?V=r.DEPTH_COMPONENT32F:y===xs&&(V=r.DEPTH_COMPONENT16),V}function T(R,y){return p(R)===!0||R.isFramebufferTexture&&R.minFilter!==Oe&&R.minFilter!==ke?Math.log2(Math.max(y.width,y.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?y.mipmaps.length:1}function A(R){const y=R.target;y.removeEventListener("dispose",A),x(y),y.isVideoTexture&&u.delete(y)}function C(R){const y=R.target;y.removeEventListener("dispose",C),k(y)}function x(R){const y=n.get(R);if(y.__webglInit===void 0)return;const V=R.source,tt=h.get(V);if(tt){const et=tt[y.__cacheKey];et.usedTimes--,et.usedTimes===0&&b(R),Object.keys(tt).length===0&&h.delete(V)}n.remove(R)}function b(R){const y=n.get(R);r.deleteTexture(y.__webglTexture);const V=R.source,tt=h.get(V);delete tt[y.__cacheKey],o.memory.textures--}function k(R){const y=n.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),n.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let tt=0;tt<6;tt++){if(Array.isArray(y.__webglFramebuffer[tt]))for(let et=0;et<y.__webglFramebuffer[tt].length;et++)r.deleteFramebuffer(y.__webglFramebuffer[tt][et]);else r.deleteFramebuffer(y.__webglFramebuffer[tt]);y.__webglDepthbuffer&&r.deleteRenderbuffer(y.__webglDepthbuffer[tt])}else{if(Array.isArray(y.__webglFramebuffer))for(let tt=0;tt<y.__webglFramebuffer.length;tt++)r.deleteFramebuffer(y.__webglFramebuffer[tt]);else r.deleteFramebuffer(y.__webglFramebuffer);if(y.__webglDepthbuffer&&r.deleteRenderbuffer(y.__webglDepthbuffer),y.__webglMultisampledFramebuffer&&r.deleteFramebuffer(y.__webglMultisampledFramebuffer),y.__webglColorRenderbuffer)for(let tt=0;tt<y.__webglColorRenderbuffer.length;tt++)y.__webglColorRenderbuffer[tt]&&r.deleteRenderbuffer(y.__webglColorRenderbuffer[tt]);y.__webglDepthRenderbuffer&&r.deleteRenderbuffer(y.__webglDepthRenderbuffer)}const V=R.textures;for(let tt=0,et=V.length;tt<et;tt++){const Q=n.get(V[tt]);Q.__webglTexture&&(r.deleteTexture(Q.__webglTexture),o.memory.textures--),n.remove(V[tt])}n.remove(R)}let P=0;function F(){P=0}function I(){const R=P;return R>=i.maxTextures&&kt("WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+i.maxTextures),P+=1,R}function N(R){const y=[];return y.push(R.wrapS),y.push(R.wrapT),y.push(R.wrapR||0),y.push(R.magFilter),y.push(R.minFilter),y.push(R.anisotropy),y.push(R.internalFormat),y.push(R.format),y.push(R.type),y.push(R.generateMipmaps),y.push(R.premultiplyAlpha),y.push(R.flipY),y.push(R.unpackAlignment),y.push(R.colorSpace),y.join()}function L(R,y){const V=n.get(R);if(R.isVideoTexture&&re(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&V.__version!==R.version){const tt=R.image;if(tt===null)kt("WebGLRenderer: Texture marked for update but no image data found.");else if(tt.complete===!1)kt("WebGLRenderer: Texture marked for update but image is incomplete");else{$(V,R,y);return}}else R.isExternalTexture&&(V.__webglTexture=R.sourceTexture?R.sourceTexture:null);e.bindTexture(r.TEXTURE_2D,V.__webglTexture,r.TEXTURE0+y)}function D(R,y){const V=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&V.__version!==R.version){$(V,R,y);return}else R.isExternalTexture&&(V.__webglTexture=R.sourceTexture?R.sourceTexture:null);e.bindTexture(r.TEXTURE_2D_ARRAY,V.__webglTexture,r.TEXTURE0+y)}function z(R,y){const V=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&V.__version!==R.version){$(V,R,y);return}e.bindTexture(r.TEXTURE_3D,V.__webglTexture,r.TEXTURE0+y)}function K(R,y){const V=n.get(R);if(R.isCubeDepthTexture!==!0&&R.version>0&&V.__version!==R.version){nt(V,R,y);return}e.bindTexture(r.TEXTURE_CUBE_MAP,V.__webglTexture,r.TEXTURE0+y)}const q={[Ro]:r.REPEAT,[Gn]:r.CLAMP_TO_EDGE,[Po]:r.MIRRORED_REPEAT},st={[Oe]:r.NEAREST,[Oh]:r.NEAREST_MIPMAP_NEAREST,[Rs]:r.NEAREST_MIPMAP_LINEAR,[ke]:r.LINEAR,[Lr]:r.LINEAR_MIPMAP_NEAREST,[xi]:r.LINEAR_MIPMAP_LINEAR},rt={[Gh]:r.NEVER,[Xh]:r.ALWAYS,[kh]:r.LESS,[wa]:r.LEQUAL,[Vh]:r.EQUAL,[Ea]:r.GEQUAL,[Hh]:r.GREATER,[Wh]:r.NOTEQUAL};function Z(R,y){if(y.type===yn&&t.has("OES_texture_float_linear")===!1&&(y.magFilter===ke||y.magFilter===Lr||y.magFilter===Rs||y.magFilter===xi||y.minFilter===ke||y.minFilter===Lr||y.minFilter===Rs||y.minFilter===xi)&&kt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(R,r.TEXTURE_WRAP_S,q[y.wrapS]),r.texParameteri(R,r.TEXTURE_WRAP_T,q[y.wrapT]),(R===r.TEXTURE_3D||R===r.TEXTURE_2D_ARRAY)&&r.texParameteri(R,r.TEXTURE_WRAP_R,q[y.wrapR]),r.texParameteri(R,r.TEXTURE_MAG_FILTER,st[y.magFilter]),r.texParameteri(R,r.TEXTURE_MIN_FILTER,st[y.minFilter]),y.compareFunction&&(r.texParameteri(R,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(R,r.TEXTURE_COMPARE_FUNC,rt[y.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(y.magFilter===Oe||y.minFilter!==Rs&&y.minFilter!==xi||y.type===yn&&t.has("OES_texture_float_linear")===!1)return;if(y.anisotropy>1||n.get(y).__currentAnisotropy){const V=t.get("EXT_texture_filter_anisotropic");r.texParameterf(R,V.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,i.getMaxAnisotropy())),n.get(y).__currentAnisotropy=y.anisotropy}}}function yt(R,y){let V=!1;R.__webglInit===void 0&&(R.__webglInit=!0,y.addEventListener("dispose",A));const tt=y.source;let et=h.get(tt);et===void 0&&(et={},h.set(tt,et));const Q=N(y);if(Q!==R.__cacheKey){et[Q]===void 0&&(et[Q]={texture:r.createTexture(),usedTimes:0},o.memory.textures++,V=!0),et[Q].usedTimes++;const Mt=et[R.__cacheKey];Mt!==void 0&&(et[R.__cacheKey].usedTimes--,Mt.usedTimes===0&&b(y)),R.__cacheKey=Q,R.__webglTexture=et[Q].texture}return V}function Kt(R,y,V){return Math.floor(Math.floor(R/V)/y)}function Ht(R,y,V,tt){const Q=R.updateRanges;if(Q.length===0)e.texSubImage2D(r.TEXTURE_2D,0,0,0,y.width,y.height,V,tt,y.data);else{Q.sort((ot,ct)=>ot.start-ct.start);let Mt=0;for(let ot=1;ot<Q.length;ot++){const ct=Q[Mt],St=Q[ot],Et=ct.start+ct.count,mt=Kt(St.start,y.width,4),Zt=Kt(ct.start,y.width,4);St.start<=Et+1&&mt===Zt&&Kt(St.start+St.count-1,y.width,4)===mt?ct.count=Math.max(ct.count,St.start+St.count-ct.start):(++Mt,Q[Mt]=St)}Q.length=Mt+1;const ht=r.getParameter(r.UNPACK_ROW_LENGTH),It=r.getParameter(r.UNPACK_SKIP_PIXELS),Bt=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,y.width);for(let ot=0,ct=Q.length;ot<ct;ot++){const St=Q[ot],Et=Math.floor(St.start/4),mt=Math.ceil(St.count/4),Zt=Et%y.width,G=Math.floor(Et/y.width),ut=mt,lt=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,Zt),r.pixelStorei(r.UNPACK_SKIP_ROWS,G),e.texSubImage2D(r.TEXTURE_2D,0,Zt,G,ut,lt,V,tt,y.data)}R.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,ht),r.pixelStorei(r.UNPACK_SKIP_PIXELS,It),r.pixelStorei(r.UNPACK_SKIP_ROWS,Bt)}}function $(R,y,V){let tt=r.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(tt=r.TEXTURE_2D_ARRAY),y.isData3DTexture&&(tt=r.TEXTURE_3D);const et=yt(R,y),Q=y.source;e.bindTexture(tt,R.__webglTexture,r.TEXTURE0+V);const Mt=n.get(Q);if(Q.version!==Mt.__version||et===!0){e.activeTexture(r.TEXTURE0+V);const ht=ne.getPrimaries(ne.workingColorSpace),It=y.colorSpace===ei?null:ne.getPrimaries(y.colorSpace),Bt=y.colorSpace===ei||ht===It?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,y.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,y.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Bt);let ot=_(y.image,!1,i.maxTextureSize);ot=pe(y,ot);const ct=s.convert(y.format,y.colorSpace),St=s.convert(y.type);let Et=S(y.internalFormat,ct,St,y.colorSpace,y.isVideoTexture);Z(tt,y);let mt;const Zt=y.mipmaps,G=y.isVideoTexture!==!0,ut=Mt.__version===void 0||et===!0,lt=Q.dataReady,_t=T(y,ot);if(y.isDepthTexture)Et=M(y.format===yi,y.type),ut&&(G?e.texStorage2D(r.TEXTURE_2D,1,Et,ot.width,ot.height):e.texImage2D(r.TEXTURE_2D,0,Et,ot.width,ot.height,0,ct,St,null));else if(y.isDataTexture)if(Zt.length>0){G&&ut&&e.texStorage2D(r.TEXTURE_2D,_t,Et,Zt[0].width,Zt[0].height);for(let at=0,J=Zt.length;at<J;at++)mt=Zt[at],G?lt&&e.texSubImage2D(r.TEXTURE_2D,at,0,0,mt.width,mt.height,ct,St,mt.data):e.texImage2D(r.TEXTURE_2D,at,Et,mt.width,mt.height,0,ct,St,mt.data);y.generateMipmaps=!1}else G?(ut&&e.texStorage2D(r.TEXTURE_2D,_t,Et,ot.width,ot.height),lt&&Ht(y,ot,ct,St)):e.texImage2D(r.TEXTURE_2D,0,Et,ot.width,ot.height,0,ct,St,ot.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){G&&ut&&e.texStorage3D(r.TEXTURE_2D_ARRAY,_t,Et,Zt[0].width,Zt[0].height,ot.depth);for(let at=0,J=Zt.length;at<J;at++)if(mt=Zt[at],y.format!==hn)if(ct!==null)if(G){if(lt)if(y.layerUpdates.size>0){const wt=wc(mt.width,mt.height,y.format,y.type);for(const Vt of y.layerUpdates){const me=mt.data.subarray(Vt*wt/mt.data.BYTES_PER_ELEMENT,(Vt+1)*wt/mt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,at,0,0,Vt,mt.width,mt.height,1,ct,me)}y.clearLayerUpdates()}else e.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,at,0,0,0,mt.width,mt.height,ot.depth,ct,mt.data)}else e.compressedTexImage3D(r.TEXTURE_2D_ARRAY,at,Et,mt.width,mt.height,ot.depth,0,mt.data,0,0);else kt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else G?lt&&e.texSubImage3D(r.TEXTURE_2D_ARRAY,at,0,0,0,mt.width,mt.height,ot.depth,ct,St,mt.data):e.texImage3D(r.TEXTURE_2D_ARRAY,at,Et,mt.width,mt.height,ot.depth,0,ct,St,mt.data)}else{G&&ut&&e.texStorage2D(r.TEXTURE_2D,_t,Et,Zt[0].width,Zt[0].height);for(let at=0,J=Zt.length;at<J;at++)mt=Zt[at],y.format!==hn?ct!==null?G?lt&&e.compressedTexSubImage2D(r.TEXTURE_2D,at,0,0,mt.width,mt.height,ct,mt.data):e.compressedTexImage2D(r.TEXTURE_2D,at,Et,mt.width,mt.height,0,mt.data):kt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):G?lt&&e.texSubImage2D(r.TEXTURE_2D,at,0,0,mt.width,mt.height,ct,St,mt.data):e.texImage2D(r.TEXTURE_2D,at,Et,mt.width,mt.height,0,ct,St,mt.data)}else if(y.isDataArrayTexture)if(G){if(ut&&e.texStorage3D(r.TEXTURE_2D_ARRAY,_t,Et,ot.width,ot.height,ot.depth),lt)if(y.layerUpdates.size>0){const at=wc(ot.width,ot.height,y.format,y.type);for(const J of y.layerUpdates){const wt=ot.data.subarray(J*at/ot.data.BYTES_PER_ELEMENT,(J+1)*at/ot.data.BYTES_PER_ELEMENT);e.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,J,ot.width,ot.height,1,ct,St,wt)}y.clearLayerUpdates()}else e.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,ot.width,ot.height,ot.depth,ct,St,ot.data)}else e.texImage3D(r.TEXTURE_2D_ARRAY,0,Et,ot.width,ot.height,ot.depth,0,ct,St,ot.data);else if(y.isData3DTexture)G?(ut&&e.texStorage3D(r.TEXTURE_3D,_t,Et,ot.width,ot.height,ot.depth),lt&&e.texSubImage3D(r.TEXTURE_3D,0,0,0,0,ot.width,ot.height,ot.depth,ct,St,ot.data)):e.texImage3D(r.TEXTURE_3D,0,Et,ot.width,ot.height,ot.depth,0,ct,St,ot.data);else if(y.isFramebufferTexture){if(ut)if(G)e.texStorage2D(r.TEXTURE_2D,_t,Et,ot.width,ot.height);else{let at=ot.width,J=ot.height;for(let wt=0;wt<_t;wt++)e.texImage2D(r.TEXTURE_2D,wt,Et,at,J,0,ct,St,null),at>>=1,J>>=1}}else if(Zt.length>0){if(G&&ut){const at=At(Zt[0]);e.texStorage2D(r.TEXTURE_2D,_t,Et,at.width,at.height)}for(let at=0,J=Zt.length;at<J;at++)mt=Zt[at],G?lt&&e.texSubImage2D(r.TEXTURE_2D,at,0,0,ct,St,mt):e.texImage2D(r.TEXTURE_2D,at,Et,ct,St,mt);y.generateMipmaps=!1}else if(G){if(ut){const at=At(ot);e.texStorage2D(r.TEXTURE_2D,_t,Et,at.width,at.height)}lt&&e.texSubImage2D(r.TEXTURE_2D,0,0,0,ct,St,ot)}else e.texImage2D(r.TEXTURE_2D,0,Et,ct,St,ot);p(y)&&g(tt),Mt.__version=Q.version,y.onUpdate&&y.onUpdate(y)}R.__version=y.version}function nt(R,y,V){if(y.image.length!==6)return;const tt=yt(R,y),et=y.source;e.bindTexture(r.TEXTURE_CUBE_MAP,R.__webglTexture,r.TEXTURE0+V);const Q=n.get(et);if(et.version!==Q.__version||tt===!0){e.activeTexture(r.TEXTURE0+V);const Mt=ne.getPrimaries(ne.workingColorSpace),ht=y.colorSpace===ei?null:ne.getPrimaries(y.colorSpace),It=y.colorSpace===ei||Mt===ht?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,y.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,y.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,It);const Bt=y.isCompressedTexture||y.image[0].isCompressedTexture,ot=y.image[0]&&y.image[0].isDataTexture,ct=[];for(let J=0;J<6;J++)!Bt&&!ot?ct[J]=_(y.image[J],!0,i.maxCubemapSize):ct[J]=ot?y.image[J].image:y.image[J],ct[J]=pe(y,ct[J]);const St=ct[0],Et=s.convert(y.format,y.colorSpace),mt=s.convert(y.type),Zt=S(y.internalFormat,Et,mt,y.colorSpace),G=y.isVideoTexture!==!0,ut=Q.__version===void 0||tt===!0,lt=et.dataReady;let _t=T(y,St);Z(r.TEXTURE_CUBE_MAP,y);let at;if(Bt){G&&ut&&e.texStorage2D(r.TEXTURE_CUBE_MAP,_t,Zt,St.width,St.height);for(let J=0;J<6;J++){at=ct[J].mipmaps;for(let wt=0;wt<at.length;wt++){const Vt=at[wt];y.format!==hn?Et!==null?G?lt&&e.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,wt,0,0,Vt.width,Vt.height,Et,Vt.data):e.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,wt,Zt,Vt.width,Vt.height,0,Vt.data):kt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):G?lt&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,wt,0,0,Vt.width,Vt.height,Et,mt,Vt.data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,wt,Zt,Vt.width,Vt.height,0,Et,mt,Vt.data)}}}else{if(at=y.mipmaps,G&&ut){at.length>0&&_t++;const J=At(ct[0]);e.texStorage2D(r.TEXTURE_CUBE_MAP,_t,Zt,J.width,J.height)}for(let J=0;J<6;J++)if(ot){G?lt&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,ct[J].width,ct[J].height,Et,mt,ct[J].data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Zt,ct[J].width,ct[J].height,0,Et,mt,ct[J].data);for(let wt=0;wt<at.length;wt++){const me=at[wt].image[J].image;G?lt&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,wt+1,0,0,me.width,me.height,Et,mt,me.data):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,wt+1,Zt,me.width,me.height,0,Et,mt,me.data)}}else{G?lt&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Et,mt,ct[J]):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,Zt,Et,mt,ct[J]);for(let wt=0;wt<at.length;wt++){const Vt=at[wt];G?lt&&e.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,wt+1,0,0,Et,mt,Vt.image[J]):e.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+J,wt+1,Zt,Et,mt,Vt.image[J])}}}p(y)&&g(r.TEXTURE_CUBE_MAP),Q.__version=et.version,y.onUpdate&&y.onUpdate(y)}R.__version=y.version}function it(R,y,V,tt,et,Q){const Mt=s.convert(V.format,V.colorSpace),ht=s.convert(V.type),It=S(V.internalFormat,Mt,ht,V.colorSpace),Bt=n.get(y),ot=n.get(V);if(ot.__renderTarget=y,!Bt.__hasExternalTextures){const ct=Math.max(1,y.width>>Q),St=Math.max(1,y.height>>Q);et===r.TEXTURE_3D||et===r.TEXTURE_2D_ARRAY?e.texImage3D(et,Q,It,ct,St,y.depth,0,Mt,ht,null):e.texImage2D(et,Q,It,ct,St,0,Mt,ht,null)}e.bindFramebuffer(r.FRAMEBUFFER,R),ve(y)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,tt,et,ot.__webglTexture,0,U(y)):(et===r.TEXTURE_2D||et>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&et<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,tt,et,ot.__webglTexture,Q),e.bindFramebuffer(r.FRAMEBUFFER,null)}function Lt(R,y,V){if(r.bindRenderbuffer(r.RENDERBUFFER,R),y.depthBuffer){const tt=y.depthTexture,et=tt&&tt.isDepthTexture?tt.type:null,Q=M(y.stencilBuffer,et),Mt=y.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;ve(y)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,U(y),Q,y.width,y.height):V?r.renderbufferStorageMultisample(r.RENDERBUFFER,U(y),Q,y.width,y.height):r.renderbufferStorage(r.RENDERBUFFER,Q,y.width,y.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Mt,r.RENDERBUFFER,R)}else{const tt=y.textures;for(let et=0;et<tt.length;et++){const Q=tt[et],Mt=s.convert(Q.format,Q.colorSpace),ht=s.convert(Q.type),It=S(Q.internalFormat,Mt,ht,Q.colorSpace);ve(y)?a.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,U(y),It,y.width,y.height):V?r.renderbufferStorageMultisample(r.RENDERBUFFER,U(y),It,y.width,y.height):r.renderbufferStorage(r.RENDERBUFFER,It,y.width,y.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function Ct(R,y,V){const tt=y.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(r.FRAMEBUFFER,R),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const et=n.get(y.depthTexture);if(et.__renderTarget=y,(!et.__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),tt){if(et.__webglInit===void 0&&(et.__webglInit=!0,y.depthTexture.addEventListener("dispose",A)),et.__webglTexture===void 0){et.__webglTexture=r.createTexture(),e.bindTexture(r.TEXTURE_CUBE_MAP,et.__webglTexture),Z(r.TEXTURE_CUBE_MAP,y.depthTexture);const Bt=s.convert(y.depthTexture.format),ot=s.convert(y.depthTexture.type);let ct;y.depthTexture.format===Xn?ct=r.DEPTH_COMPONENT24:y.depthTexture.format===yi&&(ct=r.DEPTH24_STENCIL8);for(let St=0;St<6;St++)r.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+St,0,ct,y.width,y.height,0,Bt,ot,null)}}else L(y.depthTexture,0);const Q=et.__webglTexture,Mt=U(y),ht=tt?r.TEXTURE_CUBE_MAP_POSITIVE_X+V:r.TEXTURE_2D,It=y.depthTexture.format===yi?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;if(y.depthTexture.format===Xn)ve(y)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,It,ht,Q,0,Mt):r.framebufferTexture2D(r.FRAMEBUFFER,It,ht,Q,0);else if(y.depthTexture.format===yi)ve(y)?a.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,It,ht,Q,0,Mt):r.framebufferTexture2D(r.FRAMEBUFFER,It,ht,Q,0);else throw new Error("Unknown depthTexture format")}function Nt(R){const y=n.get(R),V=R.isWebGLCubeRenderTarget===!0;if(y.__boundDepthTexture!==R.depthTexture){const tt=R.depthTexture;if(y.__depthDisposeCallback&&y.__depthDisposeCallback(),tt){const et=()=>{delete y.__boundDepthTexture,delete y.__depthDisposeCallback,tt.removeEventListener("dispose",et)};tt.addEventListener("dispose",et),y.__depthDisposeCallback=et}y.__boundDepthTexture=tt}if(R.depthTexture&&!y.__autoAllocateDepthBuffer)if(V)for(let tt=0;tt<6;tt++)Ct(y.__webglFramebuffer[tt],R,tt);else{const tt=R.texture.mipmaps;tt&&tt.length>0?Ct(y.__webglFramebuffer[0],R,0):Ct(y.__webglFramebuffer,R,0)}else if(V){y.__webglDepthbuffer=[];for(let tt=0;tt<6;tt++)if(e.bindFramebuffer(r.FRAMEBUFFER,y.__webglFramebuffer[tt]),y.__webglDepthbuffer[tt]===void 0)y.__webglDepthbuffer[tt]=r.createRenderbuffer(),Lt(y.__webglDepthbuffer[tt],R,!1);else{const et=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Q=y.__webglDepthbuffer[tt];r.bindRenderbuffer(r.RENDERBUFFER,Q),r.framebufferRenderbuffer(r.FRAMEBUFFER,et,r.RENDERBUFFER,Q)}}else{const tt=R.texture.mipmaps;if(tt&&tt.length>0?e.bindFramebuffer(r.FRAMEBUFFER,y.__webglFramebuffer[0]):e.bindFramebuffer(r.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer===void 0)y.__webglDepthbuffer=r.createRenderbuffer(),Lt(y.__webglDepthbuffer,R,!1);else{const et=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Q=y.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,Q),r.framebufferRenderbuffer(r.FRAMEBUFFER,et,r.RENDERBUFFER,Q)}}e.bindFramebuffer(r.FRAMEBUFFER,null)}function fe(R,y,V){const tt=n.get(R);y!==void 0&&it(tt.__webglFramebuffer,R,R.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),V!==void 0&&Nt(R)}function Qt(R){const y=R.texture,V=n.get(R),tt=n.get(y);R.addEventListener("dispose",C);const et=R.textures,Q=R.isWebGLCubeRenderTarget===!0,Mt=et.length>1;if(Mt||(tt.__webglTexture===void 0&&(tt.__webglTexture=r.createTexture()),tt.__version=y.version,o.memory.textures++),Q){V.__webglFramebuffer=[];for(let ht=0;ht<6;ht++)if(y.mipmaps&&y.mipmaps.length>0){V.__webglFramebuffer[ht]=[];for(let It=0;It<y.mipmaps.length;It++)V.__webglFramebuffer[ht][It]=r.createFramebuffer()}else V.__webglFramebuffer[ht]=r.createFramebuffer()}else{if(y.mipmaps&&y.mipmaps.length>0){V.__webglFramebuffer=[];for(let ht=0;ht<y.mipmaps.length;ht++)V.__webglFramebuffer[ht]=r.createFramebuffer()}else V.__webglFramebuffer=r.createFramebuffer();if(Mt)for(let ht=0,It=et.length;ht<It;ht++){const Bt=n.get(et[ht]);Bt.__webglTexture===void 0&&(Bt.__webglTexture=r.createTexture(),o.memory.textures++)}if(R.samples>0&&ve(R)===!1){V.__webglMultisampledFramebuffer=r.createFramebuffer(),V.__webglColorRenderbuffer=[],e.bindFramebuffer(r.FRAMEBUFFER,V.__webglMultisampledFramebuffer);for(let ht=0;ht<et.length;ht++){const It=et[ht];V.__webglColorRenderbuffer[ht]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,V.__webglColorRenderbuffer[ht]);const Bt=s.convert(It.format,It.colorSpace),ot=s.convert(It.type),ct=S(It.internalFormat,Bt,ot,It.colorSpace,R.isXRRenderTarget===!0),St=U(R);r.renderbufferStorageMultisample(r.RENDERBUFFER,St,ct,R.width,R.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ht,r.RENDERBUFFER,V.__webglColorRenderbuffer[ht])}r.bindRenderbuffer(r.RENDERBUFFER,null),R.depthBuffer&&(V.__webglDepthRenderbuffer=r.createRenderbuffer(),Lt(V.__webglDepthRenderbuffer,R,!0)),e.bindFramebuffer(r.FRAMEBUFFER,null)}}if(Q){e.bindTexture(r.TEXTURE_CUBE_MAP,tt.__webglTexture),Z(r.TEXTURE_CUBE_MAP,y);for(let ht=0;ht<6;ht++)if(y.mipmaps&&y.mipmaps.length>0)for(let It=0;It<y.mipmaps.length;It++)it(V.__webglFramebuffer[ht][It],R,y,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ht,It);else it(V.__webglFramebuffer[ht],R,y,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ht,0);p(y)&&g(r.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(Mt){for(let ht=0,It=et.length;ht<It;ht++){const Bt=et[ht],ot=n.get(Bt);let ct=r.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(ct=R.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),e.bindTexture(ct,ot.__webglTexture),Z(ct,Bt),it(V.__webglFramebuffer,R,Bt,r.COLOR_ATTACHMENT0+ht,ct,0),p(Bt)&&g(ct)}e.unbindTexture()}else{let ht=r.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(ht=R.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),e.bindTexture(ht,tt.__webglTexture),Z(ht,y),y.mipmaps&&y.mipmaps.length>0)for(let It=0;It<y.mipmaps.length;It++)it(V.__webglFramebuffer[It],R,y,r.COLOR_ATTACHMENT0,ht,It);else it(V.__webglFramebuffer,R,y,r.COLOR_ATTACHMENT0,ht,0);p(y)&&g(ht),e.unbindTexture()}R.depthBuffer&&Nt(R)}function Dt(R){const y=R.textures;for(let V=0,tt=y.length;V<tt;V++){const et=y[V];if(p(et)){const Q=v(R),Mt=n.get(et).__webglTexture;e.bindTexture(Q,Mt),g(Q),e.unbindTexture()}}}const Ut=[],Ot=[];function $t(R){if(R.samples>0){if(ve(R)===!1){const y=R.textures,V=R.width,tt=R.height;let et=r.COLOR_BUFFER_BIT;const Q=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Mt=n.get(R),ht=y.length>1;if(ht)for(let Bt=0;Bt<y.length;Bt++)e.bindFramebuffer(r.FRAMEBUFFER,Mt.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Bt,r.RENDERBUFFER,null),e.bindFramebuffer(r.FRAMEBUFFER,Mt.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Bt,r.TEXTURE_2D,null,0);e.bindFramebuffer(r.READ_FRAMEBUFFER,Mt.__webglMultisampledFramebuffer);const It=R.texture.mipmaps;It&&It.length>0?e.bindFramebuffer(r.DRAW_FRAMEBUFFER,Mt.__webglFramebuffer[0]):e.bindFramebuffer(r.DRAW_FRAMEBUFFER,Mt.__webglFramebuffer);for(let Bt=0;Bt<y.length;Bt++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(et|=r.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(et|=r.STENCIL_BUFFER_BIT)),ht){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Mt.__webglColorRenderbuffer[Bt]);const ot=n.get(y[Bt]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,ot,0)}r.blitFramebuffer(0,0,V,tt,0,0,V,tt,et,r.NEAREST),c===!0&&(Ut.length=0,Ot.length=0,Ut.push(r.COLOR_ATTACHMENT0+Bt),R.depthBuffer&&R.resolveDepthBuffer===!1&&(Ut.push(Q),Ot.push(Q),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Ot)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,Ut))}if(e.bindFramebuffer(r.READ_FRAMEBUFFER,null),e.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),ht)for(let Bt=0;Bt<y.length;Bt++){e.bindFramebuffer(r.FRAMEBUFFER,Mt.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Bt,r.RENDERBUFFER,Mt.__webglColorRenderbuffer[Bt]);const ot=n.get(y[Bt]).__webglTexture;e.bindFramebuffer(r.FRAMEBUFFER,Mt.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Bt,r.TEXTURE_2D,ot,0)}e.bindFramebuffer(r.DRAW_FRAMEBUFFER,Mt.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&c){const y=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[y])}}}function U(R){return Math.min(i.maxSamples,R.samples)}function ve(R){const y=n.get(R);return R.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function re(R){const y=o.render.frame;u.get(R)!==y&&(u.set(R,y),R.update())}function pe(R,y){const V=R.colorSpace,tt=R.format,et=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||V!==$i&&V!==ei&&(ne.getTransfer(V)===ae?(tt!==hn||et!==Qe)&&kt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):ee("WebGLTextures: Unsupported texture color space:",V)),y}function At(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(l.width=R.naturalWidth||R.width,l.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(l.width=R.displayWidth,l.height=R.displayHeight):(l.width=R.width,l.height=R.height),l}this.allocateTextureUnit=I,this.resetTextureUnits=F,this.setTexture2D=L,this.setTexture2DArray=D,this.setTexture3D=z,this.setTextureCube=K,this.rebindTextures=fe,this.setupRenderTarget=Qt,this.updateRenderTargetMipmap=Dt,this.updateMultisampleRenderTarget=$t,this.setupDepthRenderbuffer=Nt,this.setupFrameBufferTexture=it,this.useMultisampledRTT=ve,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function y0(r,t){function e(n,i=ei){let s;const o=ne.getTransfer(i);if(n===Qe)return r.UNSIGNED_BYTE;if(n===va)return r.UNSIGNED_SHORT_4_4_4_4;if(n===xa)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Al)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===Tl)return r.UNSIGNED_INT_10F_11F_11F_REV;if(n===El)return r.BYTE;if(n===bl)return r.SHORT;if(n===xs)return r.UNSIGNED_SHORT;if(n===_a)return r.INT;if(n===En)return r.UNSIGNED_INT;if(n===yn)return r.FLOAT;if(n===Wn)return r.HALF_FLOAT;if(n===Cl)return r.ALPHA;if(n===Rl)return r.RGB;if(n===hn)return r.RGBA;if(n===Xn)return r.DEPTH_COMPONENT;if(n===yi)return r.DEPTH_STENCIL;if(n===Pl)return r.RED;if(n===ya)return r.RED_INTEGER;if(n===Ki)return r.RG;if(n===Ma)return r.RG_INTEGER;if(n===Sa)return r.RGBA_INTEGER;if(n===lr||n===hr||n===ur||n===dr)if(o===ae)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===lr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===hr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ur)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===dr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===lr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===hr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ur)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===dr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Io||n===Do||n===Lo||n===No)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Io)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Do)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Lo)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===No)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Uo||n===Fo||n===Oo||n===Bo||n===zo||n===Go||n===ko)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Uo||n===Fo)return o===ae?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Oo)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===Bo)return s.COMPRESSED_R11_EAC;if(n===zo)return s.COMPRESSED_SIGNED_R11_EAC;if(n===Go)return s.COMPRESSED_RG11_EAC;if(n===ko)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Vo||n===Ho||n===Wo||n===Xo||n===Yo||n===qo||n===jo||n===Ko||n===$o||n===Zo||n===Jo||n===Qo||n===ta||n===ea)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Vo)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ho)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Wo)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Xo)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Yo)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===qo)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===jo)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ko)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===$o)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Zo)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Jo)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Qo)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===ta)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===ea)return o===ae?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===na||n===ia||n===sa)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(n===na)return o===ae?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ia)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===sa)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ra||n===oa||n===aa||n===ca)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(n===ra)return s.COMPRESSED_RED_RGTC1_EXT;if(n===oa)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===aa)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ca)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ys?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:e}}const M0=`
void main() {
